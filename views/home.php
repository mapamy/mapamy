...
<main class="main home">
    ...
    <h2><?= __('Wanna see your map here?') ?></h2>
    <p><?= __('Well, just login and create it. You can also create private maps if you want!') ?></p>
    <figure>
        <img src="/dist/mapamy-vision-home.png" alt="Create and Share custom maps">
    </figure>
    <?php
